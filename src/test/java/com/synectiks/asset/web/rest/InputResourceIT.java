...
public class InputResourceIT {
    ...
    private static final byte[] DEFAULT_SECURE_INPUT_DATA = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_SECURE_INPUT_DATA = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_SECURE_INPUT_DATA_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_SECURE_INPUT_DATA_CONTENT_TYPE = "image/png";

    private static final String DEFAULT_DAPR_PUB_SUB_NAME = "AAAAAAAAAA";
    private static final String UPDATED_DAPR_PUB_SUB_NAME = "BBBBBBBBBB";

    private static final String DEFAULT_DAPR_TOPIC = "AAAAAAAAAA";
    private static final String UPDATED_DAPR_TOPIC = "BBBBBBBBBB";

    private static final String DEFAULT_DAPR_ROUTE = "AAAAAAAAAA";
    private static final String UPDATED_DAPR_ROUTE = "BBBBBBBBBB";
    ...
    public static Input createEntity(EntityManager em) {
        Input input = new Input()
            ...
            .secureInputDataContentType(DEFAULT_SECURE_INPUT_DATA_CONTENT_TYPE)
            .daprPubSubName(DEFAULT_DAPR_PUB_SUB_NAME)
            .daprTopic(DEFAULT_DAPR_TOPIC)
            .daprRoute(DEFAULT_DAPR_ROUTE)
    ...
    public static Input createUpdatedEntity(EntityManager em) {
        Input input = new Input()
            ...
            .secureInputDataContentType(UPDATED_SECURE_INPUT_DATA_CONTENT_TYPE)
            .daprPubSubName(UPDATED_DAPR_PUB_SUB_NAME)
            .daprTopic(UPDATED_DAPR_TOPIC)
            .daprRoute(UPDATED_DAPR_ROUTE)
    ...
    public void createInput() throws Exception {
        ...
        assertThat(testInput.getSecureInputDataContentType()).isEqualTo(DEFAULT_SECURE_INPUT_DATA_CONTENT_TYPE);
        assertThat(testInput.getDaprPubSubName()).isEqualTo(DEFAULT_DAPR_PUB_SUB_NAME);
        assertThat(testInput.getDaprTopic()).isEqualTo(DEFAULT_DAPR_TOPIC);
        assertThat(testInput.getDaprRoute()).isEqualTo(DEFAULT_DAPR_ROUTE);
        assertThat(testInput.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testInput.getUpdatedBy()).isEqualTo(DEFAULT_UPDATED_BY);
    }
    ...
    public void getAllInputs() throws Exception {
        ...
        restInputMockMvc.perform(get("/api/inputs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].secureInputDataContentType").value(hasItem(DEFAULT_SECURE_INPUT_DATA_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].secureInputData").value(hasItem(Base64Utils.encodeToString(DEFAULT_SECURE_INPUT_DATA))))
            .andExpect(jsonPath("$.[*].daprPubSubName").value(hasItem(DEFAULT_DAPR_PUB_SUB_NAME)))
            .andExpect(jsonPath("$.[*].daprTopic").value(hasItem(DEFAULT_DAPR_TOPIC)))
            .andExpect(jsonPath("$.[*].daprRoute").value(hasItem(DEFAULT_DAPR_ROUTE)))
    ...
    public void getInput() throws Exception {
        ...
        restInputMockMvc.perform(get("/api/inputs/{id}", input.getId()))
            ...
            .andExpect(jsonPath("$.secureInputDataContentType").value(DEFAULT_SECURE_INPUT_DATA_CONTENT_TYPE))
            .andExpect(jsonPath("$.secureInputData").value(Base64Utils.encodeToString(DEFAULT_SECURE_INPUT_DATA)))
            .andExpect(jsonPath("$.daprPubSubName").value(DEFAULT_DAPR_PUB_SUB_NAME))
            .andExpect(jsonPath("$.daprTopic").value(DEFAULT_DAPR_TOPIC))
            .andExpect(jsonPath("$.daprRoute").value(DEFAULT_DAPR_ROUTE))
    ...
    public void updateInput() throws Exception {
        ...
        assertThat(testInput.getSecureInputDataContentType()).isEqualTo(UPDATED_SECURE_INPUT_DATA_CONTENT_TYPE);
        assertThat(testInput.getDaprPubSubName()).isEqualTo(UPDATED_DAPR_PUB_SUB_NAME);
        assertThat(testInput.getDaprTopic()).isEqualTo(UPDATED_DAPR_TOPIC);
        assertThat(testInput.getDaprRoute()).isEqualTo(UPDATED_DAPR_ROUTE);
        assertThat(testInput.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testInput.getUpdatedBy()).isEqualTo(UPDATED_UPDATED_BY);
    }
