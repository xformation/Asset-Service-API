...
public class EnvAccountResourceIT {
    ...
    public void createEnvAccount() throws Exception {
        ...
        assertThat(testEnvAccount.getJsonData()).isEqualTo(DEFAULT_JSON_DATA);
        assertThat(testEnvAccount.getJsonDataContentType()).isEqualTo(DEFAULT_JSON_DATA_CONTENT_TYPE);
        assertThat(testEnvAccount.getUpdatedBy()).isEqualTo(DEFAULT_UPDATED_BY);
        assertThat(testEnvAccount.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
    }
    ...
    public void updateEnvAccount() throws Exception {
        ...
        assertThat(testEnvAccount.getJsonData()).isEqualTo(UPDATED_JSON_DATA);
        assertThat(testEnvAccount.getJsonDataContentType()).isEqualTo(UPDATED_JSON_DATA_CONTENT_TYPE);
        assertThat(testEnvAccount.getUpdatedBy()).isEqualTo(UPDATED_UPDATED_BY);
        assertThat(testEnvAccount.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
    }
